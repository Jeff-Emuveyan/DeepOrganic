...
class AccountFragment : Fragment() {
    ...
    @Inject lateinit var signUpResponseHandler: SignUpResponseHandler
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        signUpResponseHandler.processResponse(requestCode, resultCode, IdpResponse.fromResultIntent(data),
            success = {
